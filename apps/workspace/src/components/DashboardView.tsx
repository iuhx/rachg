...
export const DashboardView: React.FC<DashboardViewProps> = ({
  ...
  return (
    <div className="workspace-view space-y-8 pb-20">
      <header className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 pt-2"><div><h1 className="type-display text-neutral-900 dark:text-white">Welcome back.</h1><p className="type-secondary mt-2">A quiet space for notes, files, and the work in between.</p></div><p className="type-body font-medium tracking-tight text-neutral-600 dark:text-neutral-300">{new Intl.DateTimeFormat('en-US', { weekday: 'short', month: 'short', day: 'numeric', year: 'numeric' }).format(new Date())}</p></header>
